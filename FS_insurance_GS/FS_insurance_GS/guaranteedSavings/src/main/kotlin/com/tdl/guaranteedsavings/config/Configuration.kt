...
object Configuration {
    ...
    fun initConfig(environment: ApplicationEnvironment) {
        env = ConfigParameters(
            ...
            ckycBaseUrl = environment.config.property("ktor.ckyc.baseUrl").getString(),
            tataAIABaseUrl = environment.config.property("ktor.tataAIA.tataAIABaseUrl").getString(),
            practice=environment.config.property("ktor.practice.practiceBaseUrl").getString()
